...
export const About = () => {
   return (
      <div name='about' className='w-full h-screen justify-between flex items-center bg-cyan-900 text-gray-300'>
         <img src={dev} className='w-[23rem] h-[20rem] justify-center rounded-tr-extraLarge
         ...
         <div className='flex flex-col justify-center items-center w-full h-full'>
            ...
            <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
               ...
               <div>
                  <p>
                     I am a student who studied web doveloper and some
                     about network and I have a diploma CNA certificate  and
                     <br />I hope to become a software developer also I am interested in
                     learning machine learning that is my information about technology.</p>
               </div>
            </div>
         </div>
      </div>
